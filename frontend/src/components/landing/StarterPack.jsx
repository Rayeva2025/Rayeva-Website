        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative group">
              {/* Main Product Image */}
              <div className="bg-gradient-to-br from-emerald-100 to-teal-100 rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-105">
                <img
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-full p-4 shadow-xl border-4 border-emerald-100 animate-pulse">
