...
const Partner = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      >
        <h2 className="text-4xl font-bold text-[#4da8b3] mb-4">Our Partners</h2>
        <div className="w-24 h-1 bg-gradient-to-r from-emerald-500 to-[#4da8b3] mx-auto rounded-full mb-6"></div>
